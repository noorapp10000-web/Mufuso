    ...
    <div className="min-h-screen gradient-bg flex flex-col items-center justify-center relative overflow-hidden" dir="rtl">
      ...
      >
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute inset-0 rounded-full bg-red-700/20 blur-2xl scale-125" />
          <div className="w-48 h-48 rounded-3xl overflow-hidden border-2 border-red-700/50 shadow-2xl relative mx-auto"
            style={{ boxShadow: "0 0 40px rgba(185,28,28,0.4), 0 0 80px rgba(185,28,28,0.15)" }}>
            <img
        ...
        <div className="space-y-2">
          ...
          <motion.p
            ...
            className="text-amber-400/80 text-sm font-medium tracking-[0.35em] uppercase"
          >
            MAFIOSO
          </motion.p>
          <motion.div
        ...
        >
          {[
            ...
            <div key={i} className="text-center p-3 rounded-2xl bg-white/[0.03] border border-white/[0.06]">
              ...
              <div className="text-xs text-zinc-500 mt-0.5" style={{ fontFamily: "'Cairo', sans-serif" }}>
                {stat.label}
              </div>
            </div>
          ))}
        ...
        <motion.button
          ...
          style={{
            fontFamily: "'Cairo', sans-serif",
            boxShadow: "0 0 30px rgba(185,28,28,0.35), 0 4px 20px rgba(0,0,0,0.5)"
          }}
        >
      ...
      >
        {[...Array(5)].map((_, i) => (
          <div key={i} className="w-1.5 h-1.5 rounded-full bg-red-900/40" />
        ))}
      </motion.div>
    </div>
  );
