    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#120204] to-[#1E0509] px-5 pt-12 pb-10">
      ...
      <div className="flex flex-col items-center gap-6 flex-1 justify-center">
        ...
        <div className="w-full max-w-xs">
          {!revealed ? (
            <button
              ...
              className="w-full py-16 rounded-2xl bg-[#2D0A10] border-2 border-gold/30 hover:border-gold/60 hover:bg-[#380C14] transition-all duration-200 active:scale-[0.97] flex flex-col items-center gap-4 shadow-xl shadow-black/40"
            >
            ...
            <div className="w-full rounded-2xl bg-[#2D0A10] border-2 border-gold/50 p-6 flex flex-col items-center gap-5 shadow-xl shadow-black/40">
              <div className="w-full rounded-xl bg-[#1A0508] border border-gold/20 p-4">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="px-8 py-4 rounded-xl bg-[#4A0E17] border border-gold/40">
        ...
        {revealed && (
          <button
            onClick={handleNext}
            className="w-full max-w-xs py-4 rounded-xl bg-gold text-[#120204] font-bold text-lg font-cairo transition-all duration-200 active:scale-[0.97] hover:bg-gold/90 shadow-lg shadow-gold/20"
          >
