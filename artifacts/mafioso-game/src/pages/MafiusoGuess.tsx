...
export default function MafiusoGuess() {
    ...
    return (
      <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#130212] to-[#20051C] px-5 pt-12 pb-10">
        <div className="flex flex-col items-center gap-4 mb-8">
          <div className="w-16 h-16 rounded-full bg-[#5B0E2E] border-2 border-gold/50 flex items-center justify-center shadow-lg shadow-gold/10">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-6">
          <div className="w-full max-w-xs p-5 rounded-2xl bg-[#350A22] border border-gold/25 text-center">
          ...
          <button
            ...
            className="w-full max-w-xs py-5 rounded-xl bg-[#5B0E2E] border border-gold/40 hover:border-gold/70 hover:bg-[#701338] text-gold font-bold text-lg font-cairo transition-all active:scale-[0.97]"
          >
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#130212] to-[#20051C] px-5 pt-12 pb-10">
      ...
      <div className="mb-5 p-4 rounded-xl bg-[#1C0418] border border-gold/10">
      ...
      <div className="flex flex-col items-center gap-4 flex-1 justify-center">
        ...
        <input
          ...
          maxLength={20}
          className="w-full max-w-xs bg-[#350A22] border-2 border-gold/30 rounded-xl py-4 px-5 text-gold text-2xl font-amiri placeholder-gold/25 focus:outline-none focus:border-gold/60 text-center"
          dir="rtl"
          autoFocus
        />
